...
#define UMA_HISTOGRAM_CUSTOM_TIMES(name, sample, min, max, bucket_count) \
  UMA_HISTOGRAM_UNUSED(name), UMA_HISTOGRAM_UNUSED(sample), UMA_HISTOGRAM_UNUSED(min), UMA_HISTOGRAM_UNUSED(max), UMA_HISTOGRAM_UNUSED(bucket_count)
...
#define UMA_HISTOGRAM_ENUMERATION(name, sample, boundary_value) \
  UMA_HISTOGRAM_UNUSED(name), UMA_HISTOGRAM_UNUSED(sample), UMA_HISTOGRAM_UNUSED(boundary_value)
#define UMA_STABILITY_HISTOGRAM_ENUMERATION(name, sample, boundary_value) \
  UMA_HISTOGRAM_UNUSED(name), UMA_HISTOGRAM_UNUSED(sample), UMA_HISTOGRAM_UNUSED(boundary_value)
#define UMA_HISTOGRAM_CUSTOM_ENUMERATION(name, sample, custom_ranges) \
  UMA_HISTOGRAM_UNUSED(name), UMA_HISTOGRAM_UNUSED(sample), UMA_HISTOGRAM_UNUSED(custom_ranges)
