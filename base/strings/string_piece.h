...
// We don't use the ones already defined for string and std::u16string directly
// because it would require the string constructors to be called, which we don't
// want.
